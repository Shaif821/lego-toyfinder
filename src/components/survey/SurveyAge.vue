<template>
  <div>
    ...
    <div class="survey__age__container">
      <div
        v-for="(legoAge, indexAge) in this.$store.state.ages"
        :key="indexAge + 'SA'"
        class="survey__age__wrapper"
      >
        <div
          :style="{ animationDelay: '1.' + indexAge + 's' }"
          class="animated survey__age__images flipInY"
          style="animation-duration: 1.7s;"
        >
          <div
            :id="legoAge.text"
            :class="legoAge.text"
            @click="$parent.changeView(legoAge)"
          >
            <img
              :id="legoAge.text"
              class="survey__age__lego__img"
              :src="legoAge.url"
              :class="legoAge.text"
        ...
        <p
          ...
          :style="{ animationDelay: '2.' + indexAge + 's' }"
