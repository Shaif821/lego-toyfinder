<template>
  <div v-if="this.$store.state.slideState === 1">
    <div class="screensaver__container">
      ...
      >
        <div :key="counter" class="screensaver__main">
          <div class="bubble__container">
            <img
              class="bubble__container--speech animated rubberBandItem"
              style="animation-delay: 0.9s"
              :style="{ margin: legoImages[counter].speechPos }"
              :src="legoImages[counter].speech"
            />
            <img
              class="bubble__container--bubble "
              src="../../assets/images/screensaver/speech-bubble.png"
            />
          </div>

          <img
            class="screensaver__lego animated bounceInLeft"
      ...
      <div class="screensaver__footer">
        ...
        <div
          class="screensaver__footer--hand animated tada infinite"
          style=" animation-duration: 3s;"
        >
          <img src="../../assets/images/layout/touch.png" />
        </div>
        <div class="screensaver__footer--text" @click="toThemes">
          <div
            style="cursor: pointer"
            class="screensaver__footer--text-wrapper"
          >
            <p class="screensaver__footer--title">Productoverzicht</p>
            <div class="screensaver__footer--button">
              <img
                class="animated"
                src="../../assets/images/layout/activity-icon-02.png"
              />
            </div>
          </div>
        </div>
...
.screensaver__tagline {
  ...
  background: url("../../assets/images/layout/separator.png") no-repeat 100%
    center;
